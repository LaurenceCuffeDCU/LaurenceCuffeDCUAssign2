...
public class MainActivity extends AppCompatActivity {
     ...
     * Includes test code to triger photo off third button
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i(VTAG,"Gallery open picPic is set ");
        mailGo = findViewById(R.id.textView3);
        ...
        mailGo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                openGallery();
            }
